...
### 结构和说明
实际上就是一个职责分离的体系
![](/assets/image/design_pattern/中介者_结构.jpg)
...
![](/assets/image/design_pattern/中介者_没有主板.jpg)
画图表示的话。就是一团乱。
![](/assets/image/design_pattern/中介者_没有主板_画图表示.jpg)
...
![](/assets/image/design_pattern/中介者_使用模式解决方案.jpg)
...
![](/assets/image/design_pattern/中介者_调用示意图.png)
